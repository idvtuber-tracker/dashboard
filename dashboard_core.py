...
ORG_MAP = {
    "pandavva": {
        ...
        "channels": [
            ("PANDAVVA Official",             "org",    "UCF_k9ltmPEdNb-fL-mQX03g"),
            ("Yudistira Yogendra 【PANDAVVA】", "talent", "UCGbzUHV3QvyWXIts9NRYIQQ"),
            ("Bima Bayusena【PANDAVVA】",       "talent", "UC-fyBdgoxN1VumuKcIB2bGg"),
            ("Arjuna Arkana【PANDAVVA】",       "talent", "UCj2RY_n9_5C6-OtM0hViytA"),
            ("Nakula Nalendra【PANDAVVA】",      "talent", "UCtGgHePeV6ePoTtlEspXJbQ"),
            ("Sadewa Sagara【PANDAVVA】",       "talent", "UCTyzuXqhHQN2BMnFJKPWphA"),
        ],
    },
    "project-livium": {
        ...
        "color":   "#47ffb2",
        "color_light": "#00804b",
        "desc":    "A dynamic VTuber project featuring twelve unique talents spanning a wide range of creative personalities.",
        "channels": [
            ("Project:LIVIUM",                            "org",    "UC0ZYul2i5OcyKbdKB2v1O2w"),
            ("Indira Naylarissa Ch.〔LiviPro〕",   "talent", "UCEHyd8YswGDJUCuoviDCBdg"),
            ("Silvia Valleria Ch.〔LiviPro〕",     "talent", "UCXRm3Aqtk5ilju1InZALcgA"),
            ("Yuura Yozakura Ch.〔LiviPro〕",      "talent", "UCrmtSeYObZJNG6OIC7Pw-_A"),
            ("Ymelia Meiru Ch.〔LiviPro〕",        "talent", "UClv13dr4Q3eptzrH-Ul4e7Q"),
            ("Fareye Closhartt Ch.〔LiviPro〕",    "talent", "UCWxX2nkr8Wks1Bzn158KxrQ"),
            ("Yuela GuiGui Ch.〔LiviPro〕",        "talent", "UCoLOgUhUF2FGwL8CphLz18g"),
            ("Lillis Infernallies Ch.〔LiviPro〕", "talent", "UCiK5wbKGPm2pOShI2gQ7ttQ"),
            ("Arvent Durra Ch.〔LiviPro〕", "talent", "UC224vi7vvhcQWtzaConN_0A"),
            ("Pierre Iddamont Ch.〔LiviPro〕", "talent", "UCjnTmhsTrrUxZOg30DJkI8g"),
            ("Edgar Tyrsonted Ch.〔LiviPro〕", "talent", "UC6i2KAFhFT7pZk79Pn4jXxg"),
            ("Kian Kishanya Ch.〔LiviPro〕", "talent", "UCXzCywJ0c8u_QfER_7Rf92A"),
            ("Wansy Hyerr Ch.〔LiviPro〕", "talent", "UCMW6eliKIUxKcjphp1lJ_Bg"),
        ],
    },
    "whicker-butler": {
    ...
    "evren-community": {
        ...
        "channels": [
            ...
            ("Aloisa Arbeiter", "talent", "UCDe1eE__iUG3iG96kAJ5h6Q"),  
            ("Mazy Mayse", "talent", "UCltu3ntH0F534yA7VhcK6mg"),  
        ],
    },
    "vilitera": {
        "label":   "VILITERA",
    ...
    "hibikasekai": {
        ...
        "channels": [
            ...
            ("Usami Cyra", "talent", "UC2EX7SiZDKQ5Y9KKDZtTYEQ"),  
            ("Nanami Chia", "talent", "UCVXRn3MbP-pgYsoVf4LOfcA"),  
            ("Tamisa Ryoko Ch.", "talent", "UCXb17fUF0E9Er-vu4TDeMXA"),  
            ("Euphyllia Crimson", "talent", "UCotx1jVFoJS8-0c8guCo8Jg"),  
            ("Homura Minami Ch.", "talent", "UC5kOewY5tFtJoLHAFsWLooA"),  
            ("Altera Kou Ch.", "talent", "UCELkQ4FRWixEa34yv6P7kLg"),  
            ("Fat waltz", "talent", "UCoEPXnuABprrP7it9cC-5rw"),  
        ],
    },
    "mejikuhibiniu": {
        "label":   "Mejikuhibiniu",
    ...
    "nawasena-live": {
        ...
        "channels": [
            ...
            ("Matchuan [NAWASENA]", "talent", "UC2Qs_LOHGe6Avwm0DbRRB9A"),            
        ],
    },
    "reverie": {
        "label":   "Reverie",
    ...
    "miqela": {
        ...
        "color":   "#f47a34",
        "color_light": "#863709",
        "desc":    "New VTuber group which consists of interesting individuals.",
        "channels": [
            ("Ayakocak【MIQELA】", "talent", "UCS_cffELfhtU0qKgRA6PnXg"),  
            ("Teaqillla Ch. 【MIQELA】", "talent", "UC2RgIksd0mSFrjnIXCuV2vA"),  
            ("Stellaria Vernakila Ch.【MIQELA】", "talent", "UC60MCyBm2tTDP1R6rWPjc4Q"),  
        ],
    },
}
